...
function computerMoveImpossible() {
  ...
  function firstCMove() {
    if (center === 1) {
      ...
      updatedGameboard[center] = 2;
    }
  }

  function secondCMove() {
  ...
  function thirdCMove() {
    ...
    switch (true) {
      case ((row2Sum === 4 && cornerBL === 1) || (row2Sum === 4 && cornerBR === 1) ||
        (column2Sum === 4 && cornerBL === 1)):
        updatedGameboard[cornerTR] = 2;
        break;
      case ((row2Sum === 4 && edgeB === 1) || (diagonal1Sum === 4 && edgeL === 1)) ||
        (diagonal1Sum === 4 && cornerBL === 1) || (diagonal1Sum === 4 && edgeB === 1) ||
        (diagonal1Sum === 4 && edgeR === 1):
        updatedGameboard[edgeT] = 2;
        break;
      case ((row2Sum === 4 && cornerTR === 1) || (column2Sum === 4 && cornerBR === 1) ||
        (column2Sum === 4 && cornerTR === 1)):
        updatedGameboard[cornerBL] = 2;
        break;
      case ((row2Sum === 4 && edgeT === 1) ||
        (diagonal1Sum === 4 && edgeT === 1)):
        updatedGameboard[edgeB] = 2;
        break;
      case ((column2Sum === 4 && edgeL === 1) || (diagonal2Sum === 4 && edgeL === 1) :
        updatedGameboard[edgeR] = 2;
        break;
      case (column2Sum === 4 && edgeR === 1) || (diagonal2Sum === 4 && edgeB === 1) ||
        (diagonal2Sum === 4 && cornerBR === 1) || (diagonal2Sum && edgeR === 1) ||
        (diagonal2Sum === 4 && edgeT === 1):
        updatedGameboard[edgeL] = 2;
        break;
      case :
        updatedGameboard[]
